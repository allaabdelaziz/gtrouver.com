...
class CategoriesController extends AbstractController
{
    ...
    #[Route('/new', name: 'app_categories_new', methods: ['GET', 'POST']), IsGranted("ROLE_ADMIN")]
    ...
    #[Route('/{id}/edit', name: 'app_categories_edit', methods: ['GET', 'POST']), IsGranted("ROLE_ADMIN")]
    ...
    #[Route('/{id}', name: 'app_categories_delete', methods: ['POST']), IsGranted("ROLE_ADMIN")]

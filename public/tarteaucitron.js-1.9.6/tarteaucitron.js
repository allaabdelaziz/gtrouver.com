          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addInternalScript(pathToServices, '', function () {
                ...
                if (tarteaucitron.parameters.removeCredit === false) {
                    html += '     <a class="tarteaucitronSelfLink" href="https://tarteaucitron.io/" rel="nofollow noreferrer noopener" target="_blank" title="tarteaucitron ' + tarteaucitron.lang.newWindow + '"><img src="../images/logo/g-logo-18mm.png" alt="tarteaucitron.io" /></a>';
                }
                html += '       </div>';
                html += '   </div>';
                html += '</div>';
                ...
                if (tarteaucitron.parameters.showIcon === true) {
                    ...
                    html += '       <img <img src="../images/logo/g-logo-18mm.png">';
                    html += '   </button>';
                    html += '</div>';
                }
